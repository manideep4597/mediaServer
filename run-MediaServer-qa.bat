...
docker-compose -f ./OvenMediaEngine/docker-compose.yml up -d qa
...
javaw -jar -Dspring.profiles.active=qa offshore-video-streaming/target/offshore-video-streaming-0.0.1-SNAPSHOT.jar